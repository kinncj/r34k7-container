(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["r34k7Container"] = factory();
	else
		root["r34k7Container"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _r34k7Dispatcher = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"r34k7/dispatcher\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _r34k7Dispatcher2 = _interopRequireDefault(_r34k7Dispatcher);

	var _r34k7Event = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"r34k7/event\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _r34k7Event2 = _interopRequireDefault(_r34k7Event);

	for (var Component____Key in _reactAddons.Component) {
	    if (_reactAddons.Component.hasOwnProperty(Component____Key)) {
	        Handler[Component____Key] = _reactAddons.Component[Component____Key];
	    }
	}var ____SuperProtoOfComponent = _reactAddons.Component === null ? null : _reactAddons.Component.prototype;Handler.prototype = Object.create(____SuperProtoOfComponent);Handler.prototype.constructor = Handler;Handler.__superConstructor__ = _reactAddons.Component;function Handler() {
	    if (_reactAddons.Component !== null) {
	        _reactAddons.Component.apply(this, arguments);
	    }
	}
	Handler.prototype.onClick = function () {
	    var eventName = _r34k7Event2['default'].mask.replace('%TARGET%', this.props.target).replace('%ACTION%', this.props.action),
	        dispatcher = new _r34k7Dispatcher2['default']();

	    dispatcher.dispatch(eventName);
	};

	Handler.prototype.render = function () {
	    return (0, _reactAddons.cloneElement)(this.props.children, { onClick: this.onClick.bind(this) });
	};
